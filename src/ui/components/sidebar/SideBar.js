...
export default function SideBar({ openSideBars }) {

    const classname = (openSideBars) ? "sideBar open" : "sideBar"
    const hideLabel = (openSideBars) ? "sideBarTitle" : "sideBarTitle close"
                ...
                <div className='sideBarMenu'>
                    <Link id='todo' to='/todo' className='link' onClick={linkClickHandeller}>
                        <div id='todo' ref={linkTodoRef} className='sideBarListItem' >
                            ...
                            <h3 className={hideLabel}>Notes</h3>
                        </div>
                    </Link>
                    ...
                    <Link id='editLabel' to='' className='link' onClick={linkClickHandeller}>
                        <div id='editLabel' className='sideBarListItem'>
                            ...
                            <h3 className={hideLabel}>Edit Label</h3>
                        </div>
                    </Link>
                    ...
                    <Link id='archive' to='/archive' className='link' onClick={linkClickHandeller}>
                        <div id='archive' ref={linkArchiveRef} className='sideBarListItem'>
                            ...
                            <h3 className={hideLabel}>Archive</h3>
                        </div>
                    </Link>

                    <Link id='trash' to='/trash' className='link' onClick={linkClickHandeller}>
                        <div id='trash' ref={linkTrashRef} className='sideBarListItem'>
                            <svg id='trash' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M15 4V3H9v1H4v2h1v13c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6h1V4h-5zm2 15H7V6h10v13z"></path><path d="M9 8h2v9H9zm4 0h2v9h-2z"></path></svg>
                            <h3 className={hideLabel}>Trash</h3>
                        </div>
                    </Link>
